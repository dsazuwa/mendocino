...
DROP FUNCTION IF EXISTS menu.insert_modifier_group(vARCHAR(100), BOOLEAN, BOOLEAN, INTEGER, INTEGER, INTEGER);
...
DROP FUNCTION IF EXISTS menu.insert_modifiers_and_options(VARCHAR(100), INTEGER, DECIMAL(10, 2), BOOLEAN, BOOLEAN, INTEGER, INTEGER, INTEGER, JSONB[]);
